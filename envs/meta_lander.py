...
class MetaLander(gym.Env, EzPickle):
    """
    ### Description
    ...
    def __init__(
        ...
        # Reward factors weighting the main & side engine
        self.kappa = kappa
    ...
    def step(self, action):
        ...
        reward -= (
            m_power * self.kappa[0]
        )  # less fuel spent is better, about -30 for heuristic landing
        reward -= s_power * self.kappa[1]
...
if __name__ == "__main__":
    demo_heuristic_lander(MetaLander(), render=True)
